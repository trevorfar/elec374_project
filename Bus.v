...
//	 zlowout, zhighout, LOout, HIout, {Result_out}}) // 0000000
    ...
    Mux32to1 multiplexer (
        ...
        .I15(R15_data), .I16(HI_data), .I17(LO_data), .I18(z_high_data_out), .I19(z_low_data_out),
        .I20(PC_data), .I21(MDR_data), .I22(InPort_data), .I23(C_data), .I24(32'd0), .I25(32'd0), .I26(32'd0), .I27(32'd0),
        .I28(32'd0), .I29(32'd0), .I30(32'd0), .I31(32'd0),
        .signal(select_signals),
        .BusMuxOut(muxOut)
    );
